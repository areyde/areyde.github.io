...
description: "A large-scale, diverse multilingual dataset for commit message generation and completion: more than 10 million carefully filtered commits."
collection: datasets
permalink: /datasets/commit-chronicle
redirect_from:
  - /dataset/commit-chronicle
  - /dataset/commit-chronicle/
tag: 'A large-scale, diverse multilingual dataset for commit message generation and completion: more than 10 million carefully filtered commits.'
