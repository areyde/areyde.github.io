---
title: "Buckwheat"
description: "A multi-language tokenizer for extracting identifiers from source code."
collection: tools
permalink: /tools/buckwheat
redirect_from:
  - /tool/buckwheat
  - /tool/buckwheat/
tag: 'A multi-language tokenizer for extracting identifiers from source code. This one I actually developed from scratch, used it in two different research projects, and passed on to an intern.'
