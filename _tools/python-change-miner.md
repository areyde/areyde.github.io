...
tag: 'A tool for creating fine-grained program dependence graphs (fgPDG) for Python code, creating change graphs from them, and mining these graphs for change patterns. I provided the requirements for the tool, helped write the documentation, conducted a study with it, and wrote a paper.'
